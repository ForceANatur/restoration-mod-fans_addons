...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks_Eng", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deck9_tonyr_desc_sc"] = "Your #{skill_color}#Brass Knuckles## deal #{skill_color}#$perk_value_1## more damage.\n\n#{important_1}#Enemies like## #{risk}#Captains and VIP targets## #{important_1}#take less damage from your## #{risk}#Brass Knuckles.##\n#{important_1}#The effects of## #{risk}#Overdose's dodge-on-kill and Showdown's panic## #{important_1}#are reduced.##\nYour base point value is reduced to #{important_1}#$perk_value_4.##\nYour maximum combo is reduced by #{important_1}#$perk_value_6.##\nYour combo decay timer is reduced by #{important_1}#$perk_value_7## seconds.\nYou lose an additional #{important_1}#$perk_value_5## points of combo when taking health damage.\nYour total ammo is reduced by #{important_1}#$perk_value_2## and your ammo pickup rates are reduced by #{important_1}#$perk_value_3.##",
