...
function MutatorMedicdozers:setup(data)
	...
	table.insert(unit_types.zombie, Idstring("units/pd2_dlc_hvh/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
	...
	table.insert(unit_types_black.zombie, Idstring("units/pd2_dlc_hvh/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
	...
	table.insert(unit_types_skull.zombie, Idstring("units/pd2_dlc_hvh/characters/ene_bulldozer_medic/ene_bulldozer_medic"))
