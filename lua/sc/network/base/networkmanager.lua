...
-- 	end
-- end)
local restoration_build_key = "restoration_13_dev_FaNScout"
...
local function setup_discord_link(gold_key)
	...
	if is_gold then
		user_resmod_version = "This message should not appear, if it does, please tell FaN Scout with screenshot."
	else
