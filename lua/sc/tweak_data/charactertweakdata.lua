...
function CharacterTweakData:_init_medic(presets)	
	...
	self.medic_heavy.damage_resistance = presets.damage_resistance.none
...
function CharacterTweakData:_init_team_ai(presets)
	...
	self.ecp_male.weapon.weapons_of_choice.primary = table.random(ecp_male_rand_weap)
end
...
function CharacterTweakData:_init_boom(presets)		
	...
	self.boom_summers.tags = {"female_enemy", "custom", "special", "customvo", "captain"}
