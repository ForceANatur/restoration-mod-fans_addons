...
logic_variants.tank_hw_minion = clone(security_variant)
logic_variants.tank_hw_minion.attack = TankCopLogicAttack
...
logic_variants.shield_weekend = security_variant
logic_variants.shield_weekend_vanilla = security_variant

logic_variants.fbi_cruel = security_variant
logic_variants.hrt_cruel = security_variant
logic_variants.fbi_vet_cruel = security_variant
logic_variants.weekend_cruel = security_variant
logic_variants.weekend_vanilla_heavy_cruel = security_variant
logic_variants.shield_cruel_fbi = security_variant
